...
/**
 * The persistent class for the ref_departamento database table.
 * 
 */
@Entity
@Table(name="ref_departamento")
@NamedQuery(name="RefDepartamento.findAll", query="SELECT r FROM RefDepartamento r")
public class RefDepartamento implements Serializable {
