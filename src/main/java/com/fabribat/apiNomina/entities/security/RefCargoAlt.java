...
/**
 * The persistent class for the ref_cargo_alt database table.
 * 
 */
@Entity
@Table(name="ref_cargo_alt")
@NamedQuery(name="RefCargoAlt.findAll", query="SELECT r FROM RefCargoAlt r")
public class RefCargoAlt implements Serializable {
